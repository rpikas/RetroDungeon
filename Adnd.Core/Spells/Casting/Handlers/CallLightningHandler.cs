...
public sealed class CallLightningHandler : ISpellEffectHandler
{
    public bool CanHandle(string spellId) => string.Equals(spellId, "call_lightning", StringComparison.OrdinalIgnoreCase);
    ...
    public SpellCastResult Resolve(SpellCastRequest request)
    {
        ...
        if (request.Context != SpellUseContext.Combat)
            return SpellCastResult.Failure("Call Lightning can only be cast in combat.");
