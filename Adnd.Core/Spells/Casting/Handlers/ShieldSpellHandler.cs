...
namespace Adnd.Core.Spells.Casting.Handlers
{
    public sealed class ShieldSpellHandler : ISpellEffectHandler
    {
        public bool CanHandle(string spellId)
            => string.Equals(spellId, "shield_spell", StringComparison.OrdinalIgnoreCase)
               || string.Equals(spellId, "shield_spell_illusionist", StringComparison.OrdinalIgnoreCase);
